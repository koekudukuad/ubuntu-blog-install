...
# Information
echo -e "\\033[1;34m#### \\033[1;33m        IonCube Auto install EE PHP 5.6       \\033[1;34m #### \\033[0;39m"
echo "Run script ..."
...
echo "zend_extension=/usr/local/ioncube/ioncube_loader_lin_${VER_PHP}.so" > /etc/php/5.6/fpm/conf.d/ioncube.ini
echo "zend_extension=/usr/local/ioncube/ioncube_loader_lin_${VER_PHP}.so" > /etc/php/5.6/cli/conf.d/ioncube.ini
sed -i "1izend_extension=/usr/local/ioncube/ioncube_loader_lin_${VER_PHP}.so" /etc/php/5.6/fpm/php.ini
sed -i "1izend_extension=/usr/local/ioncube/ioncube_loader_lin_${VER_PHP}.so" /etc/php/5.6/cli/php.ini
sleep 3s
echo -e "\r\e[0;32m[OK]\e[0m Add IonCube to PHP                "

#  Reboot nginx & Php
echo -n "[In progress] Reboot nginx & Php ..."
ee stack restart 
